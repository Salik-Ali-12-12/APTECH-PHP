...
<html class="no-js" lang="en">
    ...
    <?php if($result->num_rows > 0) : ?>
        <?php while($row = $result->fetch_assoc()) : ?>
            <div class="featured-img-box col-md-4 mb-3 mt-4">
                <div class="card border-primary" style="width: 300px;">
                    <img src="<?php echo $row['car_img']; ?>" width='370' height='150' class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title text-primary">Car Name: <?php echo $row['car_name']; ?></h5>
                        <h6 class="card-subtitle mb-2 text-muted">Car Model: <?php echo $row['car_model']; ?></h6>
                        <p class="card-text">Car Description: <?php echo $row['car_description']; ?></p>
                        <a href="addtocart.php?action=add&id=<?= $row['id'] ?>">Add To Cart</a>
																							 </div>
                </div>
            </div>
        <?php endwhile; ?>
